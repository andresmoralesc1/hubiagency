    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <section className="pt-32 pb-24 px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-xl text-zinc-500 max-w-2xl mx-auto animate-fade-in-up delay-200">
            Automatiza procesos y optimiza operaciones. Reducimos errores y ahorramos horas de trabajo manual con flujos inteligentes.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-8 relative z-10">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
          {[
            "Mapeo y automatizacion de procesos",
            "Flujos de trabajo con n8n",
            "Integracion API con tu stack",
            "Reportes de tiempo ahorrado"
          ].map((feature, i) => (
