...
const socialLinks = [
  { label: "LinkedIn", href: "https://www.linkedin.com/in/andresmoralesc1/" },
  { label: "GitHub", href: "https://github.com/andresmoralesc1/" },
];
...
const contactInfo = [
  ...
  { icon: Phone, text: "+57 324 542 5387" },
  { icon: MapPin, text: "Colombia", isAddress: true },
];
  ...
  return (
    <footer className="relative w-full overflow-hidden bg-black/90 pt-16 pb-6 border-t border-zinc-800/50">
      ...
      <div className="glass-panel relative z-10 mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-t-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        ...
        {/* Navigation columns */}
        <nav className="grid w-full grid-cols-1 gap-9 text-center md:grid-cols-2 lg:grid-cols-4 md:text-left">
          <div>
