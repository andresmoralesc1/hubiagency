...
export function ShinyButton({ children, onClick, href, className = "", variant = "default" }: ShinyButtonProps) {
  const baseClasses = variant === "outline"
    ? "border border-cyan-500/50 text-cyan-400 bg-black/50 hover:bg-cyan-500/20 hover:border-cyan-400 hover:shadow-[0_0_30px_rgba(0,212,255,0.4)]"
    : "bg-cyan-500 text-black hover:bg-cyan-400 active:bg-cyan-300 shadow-[0_0_20px_rgba(0,212,255,0.5)] hover:shadow-[0_0_50px_rgba(0,212,255,1)]"
